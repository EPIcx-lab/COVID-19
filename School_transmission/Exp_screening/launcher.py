...
sigma_omicron= 0.6 #0.81

betas_values=[0.012, 0.013, 0.014, 0.0153, 0.0155,  0.0165, 0.017, 0.018, 0.019]
protocols = [[1, 1, 0, 1, 0]]
alpha  = [1]
deltar = 0
delay=2
...
initial_clinical= 1 #1 #3
initial_subclinical= 3 #3 #6
initial_rp= 8 #6


str_param = "%d_b%.4f_%d_%d_%d_%d_%d%d%d%d%d%d_immu%.2f_%.2f_Pd%.2f_%.2f_%d_%d_f%d_%d_s%f"
str_launch = "./primary_epidemics %d %f %d %d %d %d %d %d %d %d %d %d %f %f %f %f %d %d %d %d %f"
