...
//void initial_status_single(metadata *data,int *status0, int *i0, int n_inf, int *r_nodes, int n_removed);
//void generator(metadata *data, int*i0, int n_inf);
//void twoday_generator(int num_day,int *introduction_days);
int day_selection_intro(int n, int *v1, int *v2, int *start, int *end, int day);
//void weekly_introduction(metadata *data, int *status, int *status0, int *introduction_days, int num_intro_day);
//int weekly_introduction(metadata *data, Teach *tc, int *status, int *status0,  int n, int *day, int *quart, int *rep);
...
//void count_intra(metadata *data, Teach *tc, int sim, int day, int index, int *status0, FILE *fp10);
...
void post_reactive(metadata *data, Teach *tc, Param *param, int clas, int day_simulation, int quarter, int sim, int *status0, int *screenstatus, int *start_q2, int *start_rq2, int *teach_rtested, int *teach_rep, int *quarantine, int *detected, int *indtotest, float **theta_pa, float **theta_ca, float **theta_sca, float **theta_rpa, int *counter_prodro, int *counter_infect, int *counter_rp, FILE *fp17, FILE *fp19);
